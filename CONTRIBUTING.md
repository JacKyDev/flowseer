...
```bash
git clone git@github.com:your-username/flowseer.git
```

- After that create a branch for your changes. For example:
  - `feature-XXX` if you will add functionality.
  - `bugfix-XXX` if you will fix a bug.
...
- Code in Rust: Embrace the power of Rust for writing your code. It helps in maintaining consistency and leveraging Rust's robust features.
...
- [Jens Schreiber](https://github.com/JacKyDev)

[fork]: https://help.github.com/articles/fork-a-repo/
[pr]: https://github.com/JacKyDev/flowseer/compare
[newissue]: https://github.com/JacKyDev/flowseer/issues/new
[issues]: https://github.com/JacKyDev/flowseer/issues